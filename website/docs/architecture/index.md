...
If you only read one page in this section, read [Overview](overview.md).

## Pages

- [Overview](overview.md) — the three build paths, the single source of truth, the design rules
- [Safety nets](safety-nets.md) — the four layers that prevent orphaned cloud resources
- [Warm-image pattern](warm-image-pattern.md) — why we never reinstall build dependencies on every run
