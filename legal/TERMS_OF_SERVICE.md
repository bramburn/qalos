...
> See [README.md](README.md) for the framework context.
...
- **"Software Licence"** means the MIT Licence (for original qalos contributions) and the Apache 2.0 Licence (for bundled AOSP components), as set out in [LICENSE](../LICENSE).
